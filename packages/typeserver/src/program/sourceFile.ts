...
import { Binder } from '../binder/binder.ts';
...
import { Diagnostic, DiagnosticCategory, TaskListToken, convertLevelToCategory } from '../common/diagnostic.ts';
import { DiagnosticRule } from '../common/diagnosticRules.ts';
import { DiagnosticSink, TextRangeDiagnosticSink } from '../common/diagnosticSink.ts';
import { convertOffsetsToRange, convertTextRangeToRange } from '../common/positionUtils.ts';
import { Range, TextRange, getEmptyRange } from '../common/textRange.ts';
import { TextRangeCollection } from '../common/textRangeCollection.ts';
import { ConfigOptions, ExecutionEnvironment, getBasicDiagnosticRuleSet } from '../config/configOptions.ts';
import { AnalyzerFileInfo, ImportLookup } from '../evaluator/analyzerFileInfo.ts';
import { TypeEvaluator } from '../evaluator/typeEvaluatorTypes.ts';
import { OperationCanceledException } from '../extensibility/cancellationUtils.ts';
...
import { ModuleNode } from '../parser/parseNodes.ts';
import { ModuleImport, ParseFileResults, ParseOptions, Parser, ParserOutput } from '../parser/parser.ts';
import { TestWalker } from '../parser/testWalker.ts';
import { IgnoreComment, Tokenizer, TokenizerOutput } from '../parser/tokenizer.ts';
import { Token } from '../parser/tokenizerTypes.ts';
import { LogTracker, getPathForLogging } from '../program/logTracker.ts';
import { Checker } from '../service/checker.ts';
...
import * as StringUtils from '../utils/stringUtils.ts';
import * as CommentUtils from './commentUtils.ts';
import { ParseTreeCleanerWalker } from './parseTreeCleaner.ts';
...
export class SourceFile {
    ...
    constructor(
        ...
        this._logTracker = logTracker ?? new LogTracker(console);
