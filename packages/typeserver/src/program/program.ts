...
import { getDocString } from '../common/parseTreeUtils';
...
import { AbsoluteModuleDescriptor, ImportLookupResult, LookupImportOptions } from '../evaluator/analyzerFileInfo';
import { createTypeEvaluator } from '../evaluator/typeEvaluator';
import { PrintTypeOptions, TypeEvaluator } from '../evaluator/typeEvaluatorTypes';
import { getPrintTypeFlags } from '../evaluator/typePrinter';
import { Type } from '../evaluator/types';
import { OperationCanceledException, throwIfCancellationRequested } from '../extensibility/cancellationUtils';
import { ConsoleInterface, StandardConsole } from '../extensibility/console';
...
import { makeDirectories } from '../files/uri/uriUtils';
...
import { LogTracker } from '../program/logTracker';
import { AnalysisCompleteCallback, analyzeProgram, RequiringAnalysisCount } from '../service/analysis';
import { CacheManager } from '../service/cacheManager';
import { CircularDependency } from '../service/circularDependency';
import { Duration, timingStats } from '../service/timing';
import { TypeStubWriter } from '../service/typeStubWriter';
...
export class Program {
    ...
    constructor(
        ...
        this._id = `Prog_${Program._nextId}`;
        Program._nextId += 1;
    }
