...
import { getScope } from '../common/analyzerNodeInfo';
...
import { TypeVarScopeId } from '../evaluator/types';
import {
    ArgCategory,
    ArgumentNode,
...
import { ParseTreeWalker, getChildNodes } from '../parser/parseTreeWalker';
...
import { containsOnlyWhitespace } from '../utils/core';
